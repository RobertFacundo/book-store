    ...
    return (
        <div className="flex lg:flex-row flex-col gap-5 ">
            ...
            <div className="flex flex-col text-right">
                <h1 className="author-title text-yellow-500 text-4xl tracking-wide font-[family-name:var(--font-display)] pr-3">{author}</h1>
                <p className="author-description text-white/50 tracking-normal text-lg">
