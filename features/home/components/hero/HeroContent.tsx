...
import { useHeroContentAnimation } from "../../animations/useHeroContentAnimation";

const HeroContent = () => {
    const ref = useRef<HTMLDivElement>(null);
    useHeroContentAnimation(ref)
    return (
        <div ref={ref} className="flex flex-col gap-14 max-w-xl text-white opacity-0">
