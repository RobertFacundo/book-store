...
const BestSellersCard = ({ item }: BestSellersCardProps) => {
    ...
    return (
        <div className="flex flex-col gap-1 rounded-md bg-zinc-700/20 border border-white/10 transition-all ease-in-out duration-400 hover:scale-103" >
            <Image src={img} alt="title" className="h-[500px] sm:[450px] md:[300px] lg:h-[330px]  px-4 py-2 w-full"/>
