    ...
    return (
        <div className="flex h-[300px]">
            ...
            <div className="flex flex-col w-1/2 bg-black text-white items-start justify-center lg:gap-10 gap-8 px-10 lg:px-16 font-[family-name:var(--font-ui)] ">
                <h1 className='text-2xl lg:text-5xl font-light tracking-wide'>Dont miss out!</h1>
                <p className='lg:text-xl text-md text-zinc-500'>Subscribe to receive news, new releases, and exclusive recommendations</p>
                <div className="relative flex w-fit  bg-zinc-700/30 rounded-md border border-white/30">
