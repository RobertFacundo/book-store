const HeroContent = () => {
    return (
        <div className="flex flex-col gap-14 max-w-xl text-white ">
            ...
            <button className="font-[family-name:var(--font-display)] text-4xl md:self-start px-6 py-3 border border-yellow-500 bg-transparent text-yellow-500 hover:bg-yellow-500 hover:text-black transition-colors ease-in-out duration-700 rounded-md cursor-pointer z-20">
                Explore collection
            </button>
