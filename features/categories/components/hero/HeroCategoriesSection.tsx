...
const HeroCategoriesSection = () => {
    return (
        <div className="relative lg:h-[70vh] h-screen">
            ...
            <div className="absolute inset-0 flex items-center  p-10">
                <p className='text-white/70 font-[family-name:var(--font-display)] lg:text-5xl text-5xl lg:max-w-[560px] tracking-wide'>
